  ...
  module Cpp
    ...
    module Manglers
      ...
      module GCC4X
        ...
        class MangledIdentifier < MangledSymbol
          def initialize sym
        ...
        class MangledType < MangledSymbol
          ...
          def template *params
            @template = true
            @template_params = MangledType.ary(params)
            self
          end
        ...
        class Function < MangledSymbol
          def initialize name, params
            @name = name
            @params = params.empty? ? [MangledType.new(:void)] : params
          end
        ...
        def mangle_function name, params
          Function.new(MangledIdentifier.new(name), MangledType.ary(params)).to_s
        end
        ...
        def mangle_method klass, name, params
          Method.new(MangledType.new(klass), MangledIdentifier.new(name), MangledType.ary(params)).to_s
        end
      end
    end
