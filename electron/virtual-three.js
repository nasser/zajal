...
ThreeRendererNode.prototype.render = function() {
  if(!this._cachedRenderer) {
    this._cachedRenderer = new THREE.WebGLRenderer(this.props);
    for(k in this.props) {
      this._cachedRenderer[k] = this.props[k];
    }
    this.camera.render();
    this.scene.render();
  }
...
ThreeRendererNode.prototype.reconcile = function(other) {
  ...
  if(this.props !== other.props)
    mergeProps(this._cachedRenderer, this.props, other.props);
  
  this.camera.reconcile(other.camera);
  this.scene.reconcile(other.scene);
  
  // propagate the cache
  other._cachedRenderer = this._cachedRenderer;
};
...
var rednerer = function(props, camera, scene) { return new ThreeRendererNode(props, camera, scene); }
var perspectiveCamera = function(props) { return new ThreePerspectiveCameraNode(props); }
var scene = function(props, children) { return new ThreeSceneNode(props, children); }
var mesh = function(props, children) { return new ThreeMeshNode(props, children); }
