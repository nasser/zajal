...
var G__8404 = (node__$1.arr[((i__$1 >> shift__$2) & (31))]);
var G__8405 = (shift__$2 - (5));
node__$1 = G__8404;
shift__$2 = G__8405;
continue;
}
...
var G__8407 = i__$2;
var G__8408 = (node.arr[j]);
var G__8409 = (shift__$1 - (5));
i__$1 = G__8407;
node = G__8408;
shift__$1 = G__8409;
continue;
...
var n_8414 = ret;
var shift_8415__$1 = shift;
while(true){
var arr_8416__$1 = n_8414.arr;
var subidx_8417 = (((cnt - (1)) >> shift_8415__$1) & (31));
if((shift_8415__$1 === (5))){
(arr_8416__$1[subidx_8417] = tail_node);
} else {
var temp__4655__auto___8418 = (arr_8416__$1[subidx_8417]);
if(cljs.core.truth_(temp__4655__auto___8418)){
var child_8419 = temp__4655__auto___8418;
var new_carr_8420 = cljs.core.aclone.call(null,child_8419.arr);
var new_child_8421 = cljs.core.__GT_VectorNode.call(null,root_edit,new_carr_8420);
(arr_8416__$1[subidx_8417] = new_child_8421);

var G__8422 = new_child_8421;
var G__8423 = (shift_8415__$1 - (5));
n_8414 = G__8422;
shift_8415__$1 = G__8423;
continue;
} else {
(arr_8416__$1[subidx_8417] = clojure.core.rrb_vector.trees.new_path.call(null,tail_node.arr,root_edit,(shift_8415__$1 - (5)),tail_node));
}
}
break;
}
...
var shift_8425__$1 = shift;
var node_8426__$1 = node;
while(true){
if((shift_8425__$1 === (0))){
var arr_8427 = node_8426__$1.arr;
(arr_8427[(i & (31))] = val);
} else {
var arr_8428 = node_8426__$1.arr;
var subidx_8429 = ((i >> shift_8425__$1) & (31));
var child_8430 = clojure.core.rrb_vector.nodes.clone.call(null,shift_8425__$1,(arr_8428[subidx_8429]));
(arr_8428[subidx_8429] = child_8430);

var G__8431 = (shift_8425__$1 - (5));
var G__8432 = child_8430;
shift_8425__$1 = G__8431;
node_8426__$1 = G__8432;
continue;
}
break;
}
...
//# sourceMappingURL=trees.js.map?rel=1476490291197