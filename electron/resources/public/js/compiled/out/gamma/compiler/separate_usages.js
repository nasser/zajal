...
return (function (p1__8827_SHARP_,p2__8828_SHARP_){
if(cljs.core.truth_(cljs.core.get.call(null,p1__8827_SHARP_,p2__8828_SHARP_))){
return p1__8827_SHARP_;
} else {
return cljs.core.assoc.call(null,p1__8827_SHARP_,p2__8828_SHARP_,cljs.core.PersistentHashSet.EMPTY);
}
});})(have_incoming))
,g,have_incoming);
});
 ...
 * cyclic, returns nil.
 */
gamma.compiler.separate_usages.kahn_sort = (function gamma$compiler$separate_usages$kahn_sort(var_args){
var args8831 = [];
var len__7280__auto___8835 = arguments.length;
var i__7281__auto___8836 = (0);
while(true){
if((i__7281__auto___8836 < len__7280__auto___8835)){
args8831.push((arguments[i__7281__auto___8836]));

var G__8837 = (i__7281__auto___8836 + (1));
i__7281__auto___8836 = G__8837;
continue;
} else {
}
break;
...
var vec__8834 = gamma.compiler.separate_usages.take_1.call(null,s);
var n = cljs.core.nth.call(null,vec__8834,(0),null);
var s_SINGLEQUOTE_ = cljs.core.nth.call(null,vec__8834,(1),null);
var m = g.call(null,n);
var g_SINGLEQUOTE_ = cljs.core.reduce.call(null,((function (g,l,s,vec__8834,n,s_SINGLEQUOTE_,m){
return (function (p1__8829_SHARP_,p2__8830_SHARP_){
return cljs.core.update_in.call(null,p1__8829_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [n], null),gamma.compiler.separate_usages.without,p2__8830_SHARP_);
});})(g,l,s,vec__8834,n,s_SINGLEQUOTE_,m))
,g,m);
var G__8839 = g_SINGLEQUOTE_;
var G__8840 = cljs.core.conj.call(null,l,n);
var G__8841 = clojure.set.union.call(null,s_SINGLEQUOTE_,clojure.set.intersection.call(null,gamma.compiler.separate_usages.no_incoming.call(null,g_SINGLEQUOTE_),m));
g = G__8839;
l = G__8840;
s = G__8841;
continue;
...
return cljs.core.map.call(null,cljs.core.first,cljs.core.filter.call(null,(function (p1__8842_SHARP_){
var u = new cljs.core.Keyword(null,"unconditional","unconditional",1829191128).cljs$core$IFn$_invoke$arity$1(cljs.core.last.call(null,p1__8842_SHARP_));
var c = new cljs.core.Keyword(null,"conditional","conditional",1441892799).cljs$core$IFn$_invoke$arity$1(cljs.core.last.call(null,p1__8842_SHARP_));
...
var shared = gamma.compiler.separate_usages.topological_sort.call(null,cljs.core.filter.call(null,(function (p1__8843_SHARP_){
return cljs.core.not.call(null,id_mappings.call(null,p1__8843_SHARP_));
...
var temp__4655__auto__ = id_mappings.call(null,y);
...
return cljs.core.update_in.call(null,db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(location)], null),(function (p1__8844_SHARP_,p2__8845_SHARP_){
return cljs.core.assoc.call(null,cljs.core.merge.call(null,cljs.core.dissoc.call(null,p1__8844_SHARP_,new cljs.core.Keyword(null,"source-id","source-id",-585995304)),p2__8845_SHARP_),new cljs.core.Keyword(null,"env","env",-1815813235),cljs.core.into.call(null,new cljs.core.Keyword(null,"env","env",-1815813235).cljs$core$IFn$_invoke$arity$1(p1__8844_SHARP_),bound_ids));
...
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"source-id","source-id",-585995304).cljs$core$IFn$_invoke$arity$1(p1__8846_SHARP_),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__8846_SHARP_)],null));
...
//# sourceMappingURL=separate_usages.js.map?rel=1476490292226