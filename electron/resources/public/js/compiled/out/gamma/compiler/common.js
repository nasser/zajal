...
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__8775_SHARP_,f],null));
});})(elt))
,cljs.core.range.call(null,(0),cljs.core.count.call(null,elt)));
} else {
if(cljs.core.map_QMARK_.call(null,elt)){
return cljs.core.mapv.call(null,((function (elt){
return (function (p1__8776_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__8776_SHARP_,f],null));
});})(elt))
...
gamma.compiler.common.merge_elements = (function gamma$compiler$common$merge_elements(var_args){
var args8779 = [];
var len__7280__auto___8782 = arguments.length;
var i__7281__auto___8783 = (0);
while(true){
if((i__7281__auto___8783 < len__7280__auto___8782)){
args8779.push((arguments[i__7281__auto___8783]));

var G__8784 = (i__7281__auto___8783 + (1));
i__7281__auto___8783 = G__8784;
continue;
} else {
}
break;
...
return cljs.core.reduce.call(null,(function (p1__8777_SHARP_,p2__8778_SHARP_){
return cljs.core.update_in.call(null,p1__8777_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__8778_SHARP_)], null),cljs.core.fnil.call(null,cljs.core.merge,cljs.core.PersistentArrayMap.EMPTY),p2__8778_SHARP_);
}),db,elements);
});
...
gamma.compiler.common.assoc_elements = (function gamma$compiler$common$assoc_elements(var_args){
var args8788 = [];
var len__7280__auto___8791 = arguments.length;
var i__7281__auto___8792 = (0);
while(true){
if((i__7281__auto___8792 < len__7280__auto___8791)){
args8788.push((arguments[i__7281__auto___8792]));

var G__8793 = (i__7281__auto___8792 + (1));
i__7281__auto___8792 = G__8793;
continue;
} else {
}
break;
...
return cljs.core.assoc.call(null,p1__8786_SHARP_,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p2__8787_SHARP_),p2__8787_SHARP_);
}),db,elements);
});
...
//# sourceMappingURL=common.js.map?rel=1476490292071