...
# All shapes drawn to the screen have a position that is specified as a
# coordinate. All coordinates are measured as the distance from the origin in
# units of pixels. The origin [0, 0] is the coordinate is in the upper left of
# the window and the coordinate in the lower right is [width-1, height-1].
...
# The fill method determines whether or not shapes should be filled in.
# All shapes drawn after fill false is called will not be filled in. The
# opposite is fill true, which is the default.
fill false
color 255
